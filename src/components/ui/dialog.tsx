  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "translate-y-[-50%] gap-4 border bg-[var(--card)] p-6 shadow-lg duration-200",
    ...
    >
      ...
      <DialogPrimitive.Close className={cn(
        "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-[var(--card)] transition-opacity cursor-pointer",
